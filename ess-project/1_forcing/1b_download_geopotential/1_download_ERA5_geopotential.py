...
controlFile = input('Enter the name of the control file (without file extension): ')
controlFile += '.yaml' # add the file extension
...
def make_default_path(suffix):
    ...
    domainName = read_from_control(controlFolder/controlFile,'CONFLUENCE_DATA_DIR')
...
bounding_box = read_from_control(controlFolder/controlFile,'BOUNDING_BOX_COORDS') 
