...
Usage: python download_ERA5_surfaceLevel_annual.py <year> <coordinates> <path/to/save/data> [start_month] [end_month]
'''
...
for month in range(startMonth, endMonth + 1):
    ...
    file = forcingRawPath / ('ERA5_surface_' + str(year) + str(month).zfill(2) + '.nc')
