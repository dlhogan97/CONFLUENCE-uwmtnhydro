...
controlFolder = Path('/home/dlhogan/projects/forked-repos/CONFLUENCE-uwmtnhydro/ess-project/0_config_files')

# Store the name of the 'active' file in a variable
controlFile = 'config_East_River.yaml'
...
def read_from_control( file, setting ):
    ...
    with open(file, 'r') as stream:
        ...
        for line in control:
            ...
            if setting in line and not line.startswith('#') and not line.startswith(' '):
                break
