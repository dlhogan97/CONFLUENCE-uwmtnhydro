...
start_year = read_from_control(controlFolder/controlFile,'EXPERIMENT_TIME_START')[0:4]
end_year = read_from_control(controlFolder/controlFile,'EXPERIMENT_TIME_END')[0:4]  

# Split the string into 2 integers
years = [int(year) for year in [start_year, end_year]]
